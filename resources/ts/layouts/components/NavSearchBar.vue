...
const suggestionGroups: SuggestionGroup[] = [
  {
    ...
    content: [
      { icon: 'tabler-book-2', title: 'Courses', url: { name: 'courses' } },
      { icon: 'tabler-users', title: 'Students', url: { name: 'students' } },
      { icon: 'tabler-chart-bar', title: 'Analytics', url: { name: 'analytics' } },
      { icon: 'tabler-settings', title: 'Settings', url: { name: 'settings' } },
    ],
  },
]
